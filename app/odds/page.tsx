        ...
        <div className="bg-gray-900 text-white min-h-screen pt-8">
            <div className="max-w-6xl mx-auto">
                <div className="bg-gray-800 rounded-xl shadow-lg p-6 mb-8 border-l-4 border-purple-500">
                    <h1 className="text-4xl font-bold">Comparador de Odds</h1>
                    <p className="text-lg text-gray-300 mt-2">Encontre as melhores cotações para os seus jogos favoritos em tempo real.</p>
                </div>
