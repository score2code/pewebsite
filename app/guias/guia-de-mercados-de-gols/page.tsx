            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-gray-800 rounded-xl shadow-lg p-8">
                    ...
                    <div className="prose prose-invert max-w-none text-gray-300 space-y-6">
                        ...
                        <h2 className="text-2xl font-bold text-white">Como Funciona o Mercado Over/Under</h2>
                        ...
                        <h2 className="text-2xl font-bold text-white">Exemplos com a Linha 2.5</h2>
                        
                        <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            <h3 className="font-bold text-lg text-white">Aposta em "Mais de 2.5 Gols" (Over 2.5)</h3>
                        ...
                        <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            <h3 className="font-bold text-lg text-white">Aposta em "Menos de 2.5 Gols" (Under 2.5)</h3>
                        ...
                        <h2 className="text-2xl font-bold text-white">Analisando um Jogo para o Mercado de Gols</h2>
