...
export const metadata: Metadata = {
  title: 'Método Rollover (Privado)',
  description: 'Plano semanal avançado para cumprir rollover',
  robots: { index: false, follow: false },
};

export default function MetodoRolloverPrivadoPage() {
  return (
    <div className="min-h-screen pt-8 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="bg-light-100/50 dark:bg-dark-800/50 rounded-xl p-6 md:p-8 mb-6 md:mb-8 border border-light-300 dark:border-dark-600 shadow-custom dark:shadow-custom-dark backdrop-blur-sm">
          <h1 className="text-3xl md:text-4xl font-bold text-dark-900 dark:text-light-100 mb-2">Método Rollover</h1>
          <p className="text-base md:text-lg text-dark-900/70 dark:text-light-100/70">Plano semanal avançado para cumprir volume com segurança.</p>
          <div className="mt-3">
            <a href="/privado/backlog" className="text-sm inline-flex items-center gap-1 text-purple-700 dark:text-purple-400">Abrir Backlog →</a>
          </div>
        </header>
