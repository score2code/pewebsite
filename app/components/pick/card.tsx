...
const PickCard: React.FC<PickCardProps> = ({ pick }) => {
    ...
    return (
        <Link href={`/futebol/${hardcodedDate}/${pick.id}`}>
            <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out h-full flex flex-col">
                ...
                <div className="p-4 bg-gray-800 border-t border-gray-700">
                    <div className="flex justify-around items-center text-center text-sm text-gray-300">
