            ...
            {mainSections.map((section, index) => {
                ...
                return (
                    <Link key={index} href={section.href}>
                        <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 hover:border-green-500 transition duration-300 h-full flex flex-col justify-between">
                            <div>
