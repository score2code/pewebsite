        ...
        <div className="bg-gray-900 text-white min-h-screen pt-8">
            <div className="max-w-4xl mx-auto">
                <div className="bg-gray-800 rounded-xl shadow-lg p-6 mb-8 border-l-4 border-blue-500">
                    <h1 className="text-4xl font-bold">Análise das Melhores Casas de Apostas</h1>
                    <p className="text-lg text-gray-300 mt-2">Comparamos e avaliamos as plataformas para ajudar você a escolher a ideal.</p>
                </div>
